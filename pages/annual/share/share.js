// pages/annual/share/share.js - 年度院线电影海报生成页
const CanvasHelper = require('../../../utils/canvasHelper.js');
const DataLoader = require('../../../utils/dataLoader.js');
const AnnualLoader = require('../../../utils/annualLoader.js');
const AnnualPosterDrawer = require('../../../utils/annualPosterDrawer.js');
var adConfig = require('../../../utils/adConfig');
const rewardedSaveGate = require('../../../utils/rewardedSaveGate.js');

const TITLE = '2026 年度院线电影观影海报墙';
...
Page({
    ...
    async onLoad(options) {
        try {
            wx.setNavigationBarTitle({ title: '2026 年度院线电影海报' });
    ...
    _setupCanvas(canvasNode, resolve, reject) {
        try {
            ...
            this.posterDrawer = new AnnualPosterDrawer(this.canvasHelper);
            resolve();
        } catch (err) {
