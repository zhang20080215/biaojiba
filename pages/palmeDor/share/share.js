...
Page({
    ...
    onBack() {
        wx.navigateBack({
            fail: () => {
                wx.reLaunch({ url: '/pages/palmeDor/list/list' });
            }
        });
    },
    ...
    async loadData() {
        try {
            ...
            const { movies: allMovies, marks: allMarks } = await DataLoader.loadMoviesData('palmeDor', openid, false, QUERY_OPTIONS);
