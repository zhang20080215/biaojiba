// pages/oscarScreenplay/share/share.js
...
Page({
    ...
    async onLoad(options) {
        try {
            ...
            const themeClass = 'theme-oscar-screenplay';
            this.setData({
    ...
    onBack() {
        wx.navigateBack({
            fail: () => {
                wx.reLaunch({ url: '/pages/oscarScreenplay/list/list' });
            }
        });
    },
    ...
    async loadData() {
        try {
            ...
            const { movies: allMovies, marks: allMarks } = await DataLoader.loadMoviesData('oscarScreenplay', openid, false, QUERY_OPTIONS);
