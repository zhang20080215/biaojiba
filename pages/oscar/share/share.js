...
Page({
    ...
    async drawMovieList(skipAdjust = false) {
        ...
        if (!skipAdjust) return false; // 文字卡片固定 1242x1660，不调整高度
        return false;
    },
    ...
    drawStats(ctx, startX, startY, maxWidth) {
        ...
        statItems.forEach((item, index) => {
            ...
            const colors = {
                '已看': ['rgba(212, 175, 55, 0.2)', 'rgba(212, 175, 55, 0.1)'],
                '想看': ['rgba(255, 193, 7, 0.2)', 'rgba(255, 193, 7, 0.1)'],
                '未看': ['rgba(158, 158, 158, 0.2)', 'rgba(158, 158, 158, 0.1)']
            };
    ...
    drawMovieTagBackground(ctx, x, y, width, height, status) {
        ...
        const styles = {
            watched: { gradient: ['rgba(212, 175, 55, 0.25)', 'rgba(212, 175, 55, 0.1)'], stroke: 'rgba(212, 175, 55, 0.4)' },
            wish: { gradient: ['rgba(255, 193, 7, 0.25)', 'rgba(255, 193, 7, 0.15)'], stroke: 'rgba(255, 193, 7, 0.5)' },
            unwatched: { gradient: ['rgba(158, 158, 158, 0.2)', 'rgba(158, 158, 158, 0.1)'], stroke: 'rgba(158, 158, 158, 0.3)' }
        };
    ...
    drawMovieTagText(ctx, x, y, width, height, title, status) {
        ...
        const colors = { watched: '#d4af37', wish: '#FFC107', unwatched: '#BDBDBD' };
