...
var DYNAMIC_COVER_THEMES = [
  ...
  { id: 'sightsound_movies', theme: 'sightsound' },
  ...
  data: {
    ...
    themes: [
      ...
      },
      {
        id: 'arthouse_movies',
        title: '世界文艺电影250',
        description: '250 部作者电影与艺术电影，150 位导演、35 个国家与地区',
        image: '',
        tintClass: 'arthouse',
        userCount: 0,
        tag: '电影',
      ...
      },
      {
        ...
        title: '视与听影史TOP250',
        description: '英国《视与听》十年一度影评人票选，含并列共 264 部影史经典',
        image: '',
        tintClass: 'sightsound',
        userCount: 0,
        tag: '电影',
        category: 'movie',
        url: '/pages/genericList/list/list?theme=sightsound'
      },
      {
        id: 'douban_tv_cn',
        title: '豆瓣高分华语剧集',
  ...
  async loadUserCounts() {
    ...
    const _ = db.command;
      const themeConfigs = [
        ...
        { id: 'sightsound_movies', collection: 'generic_theme_movies', theme: 'sightsound', topFiltered: false },
