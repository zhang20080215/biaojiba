...
Page({
    ...
    onBack() {
        wx.navigateBack({
            fail: () => {
                wx.reLaunch({ url: '/pages/rtWar/list/list' });
            }
        });
    },
    ...
    async loadData() {
        try {
            ...
            const { movies: allMovies, marks: allMarks } = await DataLoader.loadMoviesData('rtWar', openid, false, QUERY_OPTIONS);
