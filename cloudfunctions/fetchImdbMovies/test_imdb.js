...
async function testFetch() {
    try {
        ...
        console.log(JSON.stringify(firstMovie.titleText, null, 2));
        if (firstMovie.originalTitleText) {
            console.log('original:', JSON.stringify(firstMovie.originalTitleText, null, 2));
        }
    } catch (e) {
