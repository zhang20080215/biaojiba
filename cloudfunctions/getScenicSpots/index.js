...
// 全国5A旅游景区读取函数：读 scenic_5a 全量（按 rank 升序）+ 该用户的 Marks，
// 返回形状与 getMoviesData / getThemeMovies 对齐（{ success, movies, marks, listVersion }），
...
exports.main = async (event) => {
    ...
    try {
        ...
        const spotsQuery = db.collection('scenic_5a').orderBy('rank', 'asc');
        ...
        console.error('getScenicSpots 失败:', err);
