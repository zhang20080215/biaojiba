...
function ImdbPosterDrawer(canvasHelper) {
    this.helper = canvasHelper;
    this.ctx = canvasHelper.ctx;
}

ImdbPosterDrawer.prototype.getTitle = function () {
    return TITLE;
};

ImdbPosterDrawer.prototype.drawPosterWall = async function (movies, canvasSize, updateProgress) {
...
ImdbPosterDrawer.prototype.drawSinglePoster = async function (movie, x, y, width, height) {
    const ctx = this.ctx;
...
ImdbPosterDrawer.prototype._drawPlaceholder = function (title, x, y, width, height) {
    const ctx = this.ctx;
...
module.exports = ImdbPosterDrawer;
