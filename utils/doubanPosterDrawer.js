...
function DoubanPosterDrawer(canvasHelper) {
    this.helper = canvasHelper;
    this.ctx = canvasHelper.ctx;
}

DoubanPosterDrawer.prototype.getTitle = function () {
    return TITLE;
};

DoubanPosterDrawer.prototype.drawPosterWall = async function (movies, canvasSize, updateProgress) {
...
DoubanPosterDrawer.prototype.drawSinglePoster = async function (movie, x, y, width, height) {
    const ctx = this.ctx;
...
DoubanPosterDrawer.prototype._drawPlaceholder = function (title, x, y, width, height) {
    const ctx = this.ctx;
...
module.exports = DoubanPosterDrawer;
