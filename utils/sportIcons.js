...
const ICONS = {
  ...
  basketball: {
    circles: [[12, 12, 8]],
    lines: [[[12, 4], [12, 20]], [[4, 12], [20, 12]], [[5.5, 6.5], [9, 12], [5.5, 17.5]], [[18.5, 6.5], [15, 12], [18.5, 17.5]]]
  },
  soccer: {
    circles: [[12, 12, 8]],
    lines: [
      [[12, 9], [14.85, 11.07], [13.76, 14.43], [10.24, 14.43], [9.15, 11.07], [12, 9]],
      [[12, 9], [12, 4.2]], [[14.85, 11.07], [19.5, 9.8]], [[13.76, 14.43], [16.5, 18.3]],
      [[10.24, 14.43], [7.5, 18.3]], [[9.15, 11.07], [4.5, 9.8]]
    ]
  },
  shuttlecock: {
    circles: [[12, 17, 2.3]],
    lines: [
      [[10.6, 15.3], [8, 6]], [[11.3, 15.5], [10.5, 5]], [[12, 15.6], [12, 4.5]],
      [[12.7, 15.5], [13.5, 5]], [[13.4, 15.3], [16, 6]], [[8, 6], [10.5, 5], [12, 4.5], [13.5, 5], [16, 6]]
    ]
  },
  paddle: {
    circles: [[10.5, 9.5, 5.5]],
    lines: [[[13, 14], [17, 19]]],
    dots: [[18, 6.5, 1.5]]
  },
  tennis: {
    circles: [[12, 12, 8]],
    lines: [[[6, 5.5], [9.5, 10], [9.5, 14], [6, 18.5]], [[18, 5.5], [14.5, 10], [14.5, 14], [18, 18.5]]]
  },
  volleyball: {
    circles: [[12, 12, 8]],
    lines: [[[7, 5.5], [11, 11], [8.5, 19.5]], [[19.5, 10], [13, 12], [16, 19.5]], [[4.5, 13.5], [11, 12.5], [12, 4]]]
  },
  golf: {
    lines: [[[7, 4], [7, 20]], [[7, 4], [15, 6.5], [7, 9]], [[4, 20], [20, 20]]],
    dots: [[16, 19, 1.4]]
  },
  ball: {
    circles: [[12, 12, 8]],
...
const TYPE_ICON = {
  ...
  // 球类（主流项目专属图标，其余共用通用「球」图标）
  '篮球': 'basketball', '足球': 'soccer', '羽毛球': 'shuttlecock', '乒乓球': 'paddle',
  '网球': 'tennis', '排球': 'volleyball', '高尔夫': 'golf',
  '台球': 'ball', '保龄球': 'ball', '棒球': 'ball', '橄榄球': 'ball',
  '壁球': 'ball', '手球': 'ball', '飞盘': 'ball'
};

const CATEGORY_ICON = { cardio: 'run', strength: 'dumbbell', ball: 'basketball', flexibility: 'yoga' };
