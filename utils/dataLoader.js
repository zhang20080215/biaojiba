...
const GENERIC_THEMES = new Set(['oscarCinematography', 'rtHorror', 'rtWar', 'rtAnimation', 'palmeDor', 'oscarScreenplay', 'letterboxd500', 'oscarForeign', 'rtAction', 'oscarDirector', 'oscarVFX', 'oscarActor', 'oscarActress', 'doubanTvCn', 'doubanTvForeign', 'doubanTvAnime', 'arthouse', 'sightsound']);
