// utils/oscarPosterDrawer.js - Oscar 海报绘制器

const TITLE = '历届奥斯卡最佳影片观影海报墙';

function OscarPosterDrawer(canvasHelper) {
    this.helper = canvasHelper;
    this.ctx = canvasHelper.ctx;
}

OscarPosterDrawer.prototype.getTitle = function () {
    return TITLE;
};
...
OscarPosterDrawer.prototype.drawSinglePoster = async function (movie, x, y, width, height) {
    const ctx = this.ctx;
...
module.exports = OscarPosterDrawer;
